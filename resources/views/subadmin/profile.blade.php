        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="{{ route('subadmin.dashboard') }}" class="flex items-center px-4 py-2 text-gray-600 hover:text-primary no-underline">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 font-medium">Sub-Administrator</p>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <form action="{{ route('subadmin.change.password') }}" method="POST">
                        @csrf
                        <div class="space-y-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Current Password</label>
                                <input type="password" name="current_password" required
                                       class="w-full p-3 border border-gray-300 rounded-lg text-sm outline-none transition-all duration-300 focus:border-primary focus:shadow-sm @error('current_password') border-red-500 @enderror">
                            ...
                            <div>
                                ...
                                <input type="password" name="new_password" id="new_password" required minlength="8"
                                       class="w-full p-3 border border-gray-300 rounded-lg text-sm outline-none transition-all duration-300 focus:border-primary focus:shadow-sm @error('new_password') border-red-500 @enderror">
                                @error('new_password')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="password" name="new_password_confirmation" required minlength="8"
                                       class="w-full p-3 border border-gray-300 rounded-lg text-sm outline-none transition-all duration-300 focus:border-primary focus:shadow-sm @error('new_password_confirmation') border-red-500 @enderror">
                            ...
                            <div class="pt-4">
                                <button type="submit" class="w-full md:w-auto px-6 py-3 bg-primary text-white border-none rounded-lg text-sm font-medium cursor-pointer transition-colors duration-300 hover:bg-indigo-900">
...
<script>
    ...
    if (passwordInput) {
        ...
        const form = document.querySelector('form[action="{{ route('subadmin.change.password') }}"]');
