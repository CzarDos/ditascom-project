...
<div class="max-w-2xl mx-auto">
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-gray-900">Add Minister</h1>
        <p class="text-gray-600 mt-1">Add a new minister to the system</p>
    </div>

    <!-- Form -->
    <div class="bg-white shadow rounded-lg">
        <form action="{{ route('admin.ministers.store') }}" method="POST" class="p-6">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="title" 
                            ...
                            <option value="Rev. Fr." {{ old('title') == 'Rev. Fr.' ? 'selected' : '' }}>Rev. Fr.</option>
                            <option value="Most Rev." {{ old('title') == 'Most Rev.' ? 'selected' : '' }}>Most Rev.</option>
                            <option value="Rt. Rev." {{ old('title') == 'Rt. Rev.' ? 'selected' : '' }}>Rt. Rev.</option>
                            <option value="Very Rev." {{ old('title') == 'Very Rev.' ? 'selected' : '' }}>Very Rev.</option>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="address" 
                                  name="address" 
                                  rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">{{ old('address') }}</textarea>
                        @error('address')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
