...
@section('title', 'Confirmation Certificates')

@section('content')
    <h2 class="text-2xl font-semibold text-[#1a237e] mb-6">Confirmation Certificates from All Parishes</h2>
                
                <!-- Search Form --> 
                <div class="mb-6"> 
                    <form action="{{ route('admin.certificates.confirmation') }}" method="GET" class="flex gap-3"> 
                        ...
                        @if(request('search')) 
                            <a href="{{ route('admin.certificates.confirmation') }}" class="px-6 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-colors">Clear</a> 
                        @endif 
                    </form> 
                </div>
                        ...
                        <table class="w-full">
                            <thead>
                                <tr class="border-b border-gray-200">
                                    ...
                                    <th class="px-6 py-4 text-left text-sm font-semibold text-primary">Date of Birth</th>
                            ...
                            <tbody>
                                @forelse($certificates as $certificate)
                                    <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4 text-sm text-gray-600">{{ $certificate->date_of_birth ? \Carbon\Carbon::parse($certificate->date_of_birth)->format('M d, Y') : 'N/A' }}</td>
        ...
        function viewDetails(certificate) {
            const content = `
                <div class="space-y-6">
                    ...
                    <div class="bg-purple-50 p-4 rounded-lg">
                        <h3 class="font-semibold text-purple-900 mb-2">Administrative Information</h3>
                        <div class="grid grid-cols-2 gap-3 text-sm">
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-200">
                        <a href="/admin/certificates/confirmation/${certificate.id}/download" 
