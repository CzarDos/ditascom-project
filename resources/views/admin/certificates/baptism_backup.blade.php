...
@section('title', 'Baptismal Certificates')

@section('content')
    <h2 class="text-2xl font-semibold text-[#1a237e] mb-6">Baptismal Certificates from All Parishes</h2>
                
                <!-- Search Form --> 
                <div class="mb-6"> 
                    <form action="{{ route('admin.certificates.baptism') }}" method="GET" class="flex gap-3"> 
                        ...
                        @if(request('search')) 
                            <a href="{{ route('admin.certificates.baptism') }}" class="px-6 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-colors">Clear</a> 
                        @endif 
                    </form> 
                </div>
                        ...
                        <table class="w-full">
                            <thead>
                                <tr class="border-b border-gray-200">
                                    ...
                                    <th class="px-6 py-4 text-left text-sm font-semibold text-primary">Mother's Name</th>
                                    <th class="px-6 py-4 text-left text-sm font-semibold text-primary">Father's Name</th>
                            ...
                            <tbody>
                                @forelse($certificates as $certificate)
                                    <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4 text-sm text-gray-600">{{ $certificate->mothers_full_name ?? 'N/A' }}</td>
                                        <td class="px-6 py-4 text-sm text-gray-600">{{ $certificate->fathers_full_name ?? 'N/A' }}</td>
            ...
            const content = `
                <div class="space-y-6">
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-200">
                        <a href="/admin/certificates/baptism/${certificate.id}/download" 
